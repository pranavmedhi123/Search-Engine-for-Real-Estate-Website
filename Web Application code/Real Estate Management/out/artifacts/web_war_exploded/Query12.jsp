...
<div class="col-sm-10">
  ...
  <hr>
  <h4>Displayed all the apartments with no Air conditioning. </h4>
  <%
    String query = "select * from apartments where apt_id IN (select apt_id from interiors where Air_Conditioning LIKE 'N')";
