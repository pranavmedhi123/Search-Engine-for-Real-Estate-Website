...
<div class="col-sm-10">
  ...
  <hr>
  <h4>Displayed apartments in Dallas, TX that costs under 100000$ and has a playschool nearby.</h4>
  <form class="form-horizontal" action="Query13.jsp" method="post">
    <div class="dropdown">
    ...
    <div class="form-group col-md-4">
      <label for="cost">Enter maximum cost</label>
      <input type="number" class="form-control" id="cost" name="cost" placeholder="Enter maximum cost" value="<%=cost%>">
    </div>
    <div class="form-group col-md-4">
  ...
  <%
    String query = "select * from apartments where cost < " +cost+ " AND apt_id IN (select apt_id from apartment_nearby_places where city LIKE '"+city+"' AND places LIKE '"+nearby+"')";
